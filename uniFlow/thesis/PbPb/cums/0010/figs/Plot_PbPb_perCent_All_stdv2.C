...
void Plot_PbPb_perCent_All_stdv2()
{
    // === Preparing canvas =================

    TString sInputFileName = "PbPb/cums/0010/v2/graphs_PbPb_FlowFluctCor.root";
    TString sOutPlotName = "PbPb_perCent_All_stdv2.pdf";
    ...
    TGaxis* gaY = new TGaxis(dXmin, 0.0, dXmin, 0.15, 0.0, 0.15);
    gaY->SetTitle("#sigma_{2}");
    TString sCorrName = "std_v2";
